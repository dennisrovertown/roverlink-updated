			...
			<div class="<?php if($terms) : foreach ($terms as $term) { echo 'term-'.$term->slug.' '; } endif; ?>portfolio-item four columns">
				...
				<div class="portfolio-it">
					...
					<div class="portfolio-overlay">
						...
						<span class="excerpt"><?php if(get_post_meta( get_the_ID(), "smitten_subtitle", true ) != '' ) { echo get_post_meta( get_the_ID(), "smitten_subtitle", true ); } else { echo substr(strip_tags(get_the_excerpt()),0,60).'...'; } ?></span>
					</div>
				</div>
				<?php echo $embedd; ?>
