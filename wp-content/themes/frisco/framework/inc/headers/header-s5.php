<header id="header-s5" class="header clearfix">
		
		<div class="container header-s5-container clearfix">
			...
			<div class="sixteen columns">
					...
					<div class="slogan"><?php echo pre_process_shortcode($data['text_header5slogan']); ?></div>
