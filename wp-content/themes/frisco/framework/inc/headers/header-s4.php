<header id="header-s4" class="header clearfix">
		
		<div class="container header-s4-container">
			...
			<div class="sixteen columns clearfix">
				...
				<div class="slogan"><?php echo pre_process_shortcode($data['text_header4slogan']); ?></div>
