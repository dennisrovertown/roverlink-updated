...
Plugin URI: http://twitter.com/creativesmitten/
Description: A simple but powerful widget to display Contact Informations.
Version: 1.00
Author: smitten
Author URI: http://twitter.com/creativesmitten/
*/
...
class widget_contact extends WP_Widget { 
	...
	function widget_contact() {
		...
		$this->WP_Widget( 'contact', __('smitten.Contact'), $widget_ops, $control_ops );
	}
	...
	function widget($args, $instance) {
		...
		<address>
			...
			<span class="phone"><strong><?php _e( 'Phone', 'smitten' ) ?>:</strong> <?php echo $instance['phone']; ?></span>
			<?php endif; ?>
	
			<?php if($instance['fax']): ?>
			<span class="fax"><strong><?php _e( 'Fax', 'smitten' ) ?>:</strong> <?php echo $instance['fax']; ?></span>
			<?php endif; ?>
	
			<?php if($instance['email']): ?>
			<span class="email"><strong><?php _e( 'E-Mail', 'smitten' ) ?>:</strong> <a href="mailto:<?php echo $instance['email']; ?>"><?php echo $instance['email']; ?></a></span>
			<?php endif; ?>
	
			<?php if($instance['web']): ?>
			<span class="web"><strong><?php _e( 'Web', 'smitten' ) ?>:</strong> <a href="<?php echo $instance['web']; ?>"><?php echo $instance['web']; ?></a></span>
			<?php endif; ?>
		</address>
	...
	function form($instance) {
		...
		//$defaults = array( 'title' => 'Twitter Widget', 'posts' => '3', 'username' => 'hellosmitten' ); // Default Values
