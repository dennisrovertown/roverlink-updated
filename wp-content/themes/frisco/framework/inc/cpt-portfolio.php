...
function portfolio_register() {  
	...
	$labels = array(
		'name' => __( 'Portfolio', 'smitten-framework' ),
		'singular_name' => __( 'Portfolio Item', 'smitten-framework' ),
		'add_new' => __( 'Add New Item', 'smitten-framework' ),
		'add_new_item' => __( 'Add New Portfolio Item', 'smitten-framework' ),
		'edit_item' => __( 'Edit Portfolio Item', 'smitten-framework' ),
		'new_item' => __( 'Add New Portfolio Item', 'smitten-framework' ),
		'view_item' => __( 'View Item', 'smitten-framework' ),
		'search_items' => __( 'Search Portfolio', 'smitten-framework' ),
		'not_found' => __( 'No portfolio items found', 'smitten-framework' ),
		'not_found_in_trash' => __( 'No portfolio items found in trash', 'smitten-framework' )
	);
