...
<div class="post clearfix">
	...
	<div class="post-image">
		<a href="<?php the_permalink(); ?>" title="<?php printf( esc_attr__('Permalink to %s', 'smitten'), the_title_attribute('echo=0') ); ?>" rel="bookmark"><div class="no-post-image-quote"></div></a>
	</div>
	<?php } ?>
