	...
	<div class="post-gallery flexslider">
		...
		<ul class="slides">
			<?php foreach( $images as $image ) :  ?>
				<li><a href="<?php the_permalink(); ?>" title="<?php printf( esc_attr__('Permalink to %s', 'smitten'), the_title_attribute('echo=0') ); ?>" rel="bookmark"><?php echo wp_get_attachment_image($image->ID, $thumbnail_size); ?></a></li>
			<?php endforeach; ?>
		</ul>
		<?php } ?>
	</div>
