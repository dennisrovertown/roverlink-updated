...
function smitten_scripts_basic() {  
	
	/* ------------------------------------------------------------------------ */
	/* Register Scripts */
	/* ------------------------------------------------------------------------ */
	wp_register_script('easing', get_template_directory_uri() . '/framework/js/easing.js', 'jquery', '1.3');
	wp_register_script('jquery.cycle2', get_template_directory_uri() . '/framework/js/jquery.cycle2.min.js', 'jquery', '2.0');
	...
	wp_register_script('gauge', get_template_directory_uri() . '/framework/js/gauge.js', 'jquery', '1.0', TRUE);
	...
	if(is_page_template('template-portfolio-col1.php') || is_page_template('template-portfolio-col2.php') || is_page_template('template-portfolio-col3.php') || is_page_template('template-portfolio-col4.php')) {
...
add_action( 'wp_enqueue_scripts', 'smitten_scripts_basic' );  

function smitten_styles_basic()  
{  
...
add_action( 'wp_enqueue_scripts', 'smitten_styles_basic', 1 ); 
