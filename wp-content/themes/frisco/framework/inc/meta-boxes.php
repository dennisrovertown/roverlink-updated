...
function rw_register_meta_boxes()
{
	...
	$meta_boxes[] = array(
		...
		'fields' => array(
			array(
					...
					'type'		=> 'select',
					'options'	=> array(
						'titlebar'			=> 'Regular Title Bar Style',
						'featuredimage'		=> 'Title Bar w/ Featured BG Image & Mask',
						'featuredimage2'	=> 'Title Bar w/ Featured BG Image Only',
			...
			array(
				...
				'id'		=> $prefix . "titleimage-breadcrumbs",
				'type'		=> 'checkbox',
				'std'		=> true
			),
			array(
			...
			'multiple'	=> false,
			'desc'		=> 'Optional: visible or hidden full width map under the header'
			)
		)
	);
		$meta_boxes[] = array(
	...
	$meta_boxes[] = array(
		...
		'fields'	=> array(
			array(
				...
				'desc'	=> 'Upload up to 20 project images for a slideshow, or only one to display a single image.<br />',
	...
	$meta_boxes[] = array(
		...
		'fields'	=> array(
			...
			array(
				'name'	=> 'Video URL or own Embedd Code<br />(Soundcloud Embedd Code Compatible)',
				'id'	=> $prefix . 'embed',
				'desc'	=> 'Paste the ID of the video you want to show, or insert own Embed Code (EX: http://www.youtube.com/watch?v=<strong>GUEZCxBcM78</strong>). <br />This will show the Video <strong>INSTEAD</strong> of the Image Slider.<br />',
				'type' 	=> 'textarea',
				'std' 	=> "",
				'cols' 	=> "40",
				'rows' 	=> "8"
